...
int main() {
    ...
    int seconds = 3661; // Выбрано количество секунд
    ...
    int number = 123;
    printf("\nИсходное число: %d\n", number);
    number = number >> 10; // Поскольку 10-й сдвиг вправо для 3-значного числа приведет к 0, так как все биты будут сдвинуты за пределы
